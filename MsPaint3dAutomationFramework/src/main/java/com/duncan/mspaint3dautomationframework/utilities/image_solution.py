...
class ImageSolution:
	...
	def calculate_template_match_coordinates(self):
		print('==========================')
		print(self._template_image)
		print(self._screenshot_image)
...
if __name__ == '__main__':
	...
	f = sys.argv[3]
	#screenshot_image = 'C:\\dev\\Java\\JavaDesktopApplicationAutomation\\MsPaint3dAutomationFramework\\src\\main\\resources\\images\\pom\\screenshot.jpg'
	#template_image = 'C:\\dev\\Java\\JavaDesktopApplicationAutomation\\MsPaint3dAutomationFramework\\src\\main\\resources\\images\\pom\\CanvasPage\\verify_triangle.jpg'
	#f = 'C:\\dev\\Java\\JavaDesktopApplicationAutomation\\MsPaint3dAutomationFramework\\src\\main\\resources\\images\\pom\\match_coordinates.txt'	
